...
public static void main(String[] args) {
	    ...
	    try {
	        while (true) {
	            url1 = new URL("http://192.168.0.108:8080/rest/robot18services/getmotorc/{id}");
	            ...
	            url2 = new URL("http://192.168.0.108:8080/rest/robot18services/getmotord/{id}");
	            ...
	            url3 = new URL("http://192.168.0.108:8080/rest/robot18services/getsec_distance/{id}");
	            ...
	            url4 = new URL("http://192.168.0.108:8080/rest/robot18services/getlinecolor/{id}");
	         ...
	         // Send Cycle to database if robot detects an obstacle
					...
					urlObstacleDistance = new URL("http://196.168.0.108:8080/rest/statistics/addobstacle/{id}//" + obstacleDistanceValue);
				...
				urlColorSensor = new URL(
						"http://196.168.0.108:8080/rest/statistics/getcolor/1/" + DEObj.getColor());
